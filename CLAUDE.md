...
- [ ] **Borrar los jugadores de prueba del ranking** (cargados 2026-09-16): `DELETE FROM gungame_playerdata WHERE authid LIKE 'TEST\_%'` y recargar GGExtras (subir de nuevo su DLL) para que `#ranking` se reescriba. Mientras existan también salen en `!top`.
