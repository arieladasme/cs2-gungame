...
| CS2 dedicated | build **25515854** (1.41.8.4 / 14184, prod actualizado 2026-09-24 — `libserver.so` cambió, pero firmas y vtables verificadas contra la de 14183: el gamedata parchado sigue valiendo) |
...
| CS2-SimpleAdmin instalado (prod) | **1.8.2b** + MenuManagerCS2 1.4.1 + PlayerSettings 0.9.4 + AnyBaseLib 0.9.4 (sin módulos Fun/Stealth); admins y sanciones en MySQL (`sa_*`) |
...
GG1MapChooser, QuakeSounds, CS2-SimpleAdmin), stats en MySQL y comunidad de Discord integrada.
...
- `docs/Bitacora-2026-09-25.md` — 23 al 25-09: tres updates de CS2 (1.41.8.2 a 1.41.8.4) y cómo validar un `libserver.so` antes de actualizar, `TerminateRound` en la función equivocada (el mapa no rotaba al ganar), CSS 1.0.375 postergado, CS2-SimpleAdmin, idioma por país, caída al ganar y el log de errores de GGExtras 0.26.0.
